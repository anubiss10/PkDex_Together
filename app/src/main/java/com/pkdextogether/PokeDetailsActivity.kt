...
import com.pkdextogether.api.PokeApiClient
import com.pkdextogether.api.PokeApiService
import com.pkdextogether.api.PokemonResponse
import com.pkdextogether.api.SpeciesResponse
            ...
            override fun onResponse(call: Call<PokemonResponse>, response: Response<PokemonResponse>) {
                if (response.isSuccessful) {
                    ...
                    pokemon?.let {
                        ...
                        Glide.with(this@PokemonDetailsActivity).load(it.sprites.front_default).into(imageView)
